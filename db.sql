...
CREATE PROCEDURE prescribe_med(IN patient_id INT, IN phys_id INT, IN drug VARCHAR(255), IN qty INT, IN refills INT)
BEGIN
    INSERT INTO Prescription (Name, Quantity, Refills) VALUES (drug, qty, refills);
    INSERT INTO MedicalRecord (EmplID, PatientID, RxNumber) VALUES (phys_id, patient_id, LAST_INSERT_ID());
END//
